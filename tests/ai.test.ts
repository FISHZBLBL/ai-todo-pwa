...
describe('AI 输出校验', () => {
  it('接受严格结构化任务', () => expect(aiResultSchema.parse({ tasks: [{ title:'测器件', dueDate:'2026-08-28', dateRange:null, startTime:'15:00', endTime:null, url:null, reminders:[] }] }).tasks).toHaveLength(1))
