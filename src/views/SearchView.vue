...
const emit = defineEmits<{ close: []; edit: [Task]; openDraft: [string] }>(); const store = useTaskStore(); const query = ref(''); const drafts = ref<Draft[]>([])
